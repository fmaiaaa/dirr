...
Versão: 16.0 (Correção de Sintaxe Final & Resiliência de Dados Direcional)
=============================================================================
"""
...
class MotorRecomendacao:
    ...
    def obter_enquadramento(self, renda, social, cotista):
        ...
        # Garante que a coluna Renda na planilha seja numérica
...
def main():
    ...
    if df_finan.empty or df_estoque.empty:
        st.warning("⚠️ O sistema está a carregar dados privados. Por favor, verifique se partilhou as planilhas e ativou a API do Drive.")
        st.stop()
