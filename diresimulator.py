...
import streamlit as st# -*- coding: utf-8 -*-
"""
=============================================================================
SISTEMA DE SIMULAÇÃO IMOBILIÁRIA - DIRE RIO V2 (MODIFICADO)
=============================================================================
...
1. Lógica de Recomendação: Agora sempre recomenda uma unidade (fallback para a mais barata).
2. Referências Financeiras: Adicionada seção informativa na etapa de fechamento.
3. Consolidação de Sugestões: Boxes de recomendação são fundidos se os imóveis sugeridos forem iguais.
=============================================================================
"""
        ...
        with tab_rec:
            ...
            if df_pool.empty:
                ...
                if v100 == v90 == v75:
                    ...
                    # Ideal e Seguro iguais (Caso extra): Exibe 2 boxes
                    c1, c2 = st.columns(2)
                    ...
                    # Todos diferentes: Exibe os 3 tradicionais
